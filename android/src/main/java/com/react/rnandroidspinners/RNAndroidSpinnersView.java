...
public class RNAndroidSpinnersView extends SpinKitView{
    ...
    public RNAndroidSpinnersView(Context context) {
        super(context);
    }
    ...
    public void setSpriteColor(int color) {
        try {
            ...
            Log.e("RNAndroidSpinners-Err", err.toString() + "when set prop color to " + color);
        }
    }
